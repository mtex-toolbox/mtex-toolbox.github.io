...
* **{% include reference.html link="http://merkel.texture.rocks/" content="S\00e9bastien Merkel" %}** (Université de Lille, France): *Microstructures in Earth mantle minerals: using MTEX to track grains and physical properties of polycrystals in high pressure experiments*
...
* **{% include reference.html link="https://www.ntnu.edu/employees/bjorn.sorensen" content="Bj\00f8rn Eske S\00f8rensen" %}** (Norwegian University of Science and Technology): *MTEX a versatile toolbox for the geologist enabling better implementation of crystallography and texture analysis in teaching and research*
