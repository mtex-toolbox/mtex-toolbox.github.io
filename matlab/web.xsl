...
<font size="2"><a href="#" data-toggle="tooltip"><xsl:attribute name="data-original-title"><xsl:text>To edit this page type edit </xsl:text><xsl:value-of select="$filename"/><xsl:text> into the Matlab commandline</xsl:text></xsl:attribute>edit page</a></font>
</xsl:template>
